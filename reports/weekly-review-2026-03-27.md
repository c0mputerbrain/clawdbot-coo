# Oops Weekly Review — 2026-03-27

**Overall Grade: F — Critical issues**

## 1. Audit Trends (Last 7 Days) [OK]

- Audits this week: 7
- Grades: B, A, A, A, A, B, B
- Avg criticals: 2.1 | Avg warnings: 9.6
- KB growth: 2276 -> 2299 files (+23)
- Memory growth: 1137 -> 1144 files (+7)
- Recurring warnings: [P1] Frontmatter (7x), [P1] Index (5x), [P1] Feedback Loop (5x), [P2] Scripts (7x)

## 2. KB Quality [OK]

- Files indexed: 2299
- Keywords: 9607
- TOPICS-INDEX.json: 523 KB
- KEYWORDS-INDEX.json: 4510 KB
- FILES-INDEX.json: 1344 KB
- Sample frontmatter check: 5/5 complete
  trading-books/setups/high-frequency-trading-a-practical-guide.md: complete
  amibroker/kb/forum/2023-06-30-amibroker-usage-some-forex-quotes-empty-in-realtime-quote-window-but-not-in-.md: complete
  amibroker/guide/chart-commentary.md: complete
  amibroker/afl-functions/categoryremovesymbol.md: complete
  amibroker/afl-functions/plotohlc.md: complete
- Topic clusters: 23

## 3. Memory Hygiene [!]

- Memory directory: 1144 files, 4.0 MB
- Daily logs: 68 total, 54 older than 14 days
- ACTION NEEDED: 54 old logs should be distilled into MEMORY.md and archived
- MEMORY.md: 68 lines, 11 KB

## 4. Script Inventory [!]

- Active scripts: 201 JS, 24 shell
...
- Version sprawl: notion-dave-mabe (2 versions), patch-charts-et-shading (2 versions), slt-enrich (2 versions)
- Archived scripts: 6

## 5. Edge Intelligence Check [!]

- directives.md: 474 lines
...
1. [CRITICAL] 6. Security: FOUND: Password in scripts/scrape-slt-backfill.js
2. [FIX] 3. Memory Hygiene: ACTION NEEDED: 54 old logs should be distilled into MEMORY.md and archived
3. [FIX] 4. Script Inventory: Version sprawl: notion-dave-mabe (2 versions), patch-charts-et-shading (2 versions), slt-enrich (2 versions)
4. [FIX] 5. Edge Intelligence Check:   FAIL: KB-SEARCH.md referenced

---

*Generated by Oops weekly-review.js — 2026-03-27T17:00:11.019Z*
