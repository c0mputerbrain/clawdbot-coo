...
- Avg criticals: 2.0 | Avg warnings: 8.7
- KB growth: 2237 -> 2276 files (+39)
- Memory growth: 1129 -> 1137 files (+8)
- Recurring warnings: [P1] Frontmatter (7x), [P2] Scripts (7x), [P1] Index (4x), [P1] Feedback Loop (4x)

## 2. KB Quality [OK]

- Files indexed: 2276
- Keywords: 9506
- TOPICS-INDEX.json: 517 KB
- KEYWORDS-INDEX.json: 4464 KB
- FILES-INDEX.json: 1329 KB
- Sample frontmatter check: 5/5 complete
  amibroker/afl-functions/trimresultrows.md: complete
  amibroker/kb/forum/2025-07-31-afl-running-amibroker-on-macbook-air-m4-windows-11-arm-via-paral.md: complete
  amibroker/kb/forum/2019-06-20-interactive-brokers-license-verified-badge.md: complete
  trade-ideas/alerts/MDAS5.md: complete
  amibroker/afl-functions/staticvarget.md: complete
- Topic clusters: 23

## 3. Memory Hygiene [!]

- Memory directory: 1137 files, 3.9 MB
- Daily logs: 61 total, 47 older than 14 days
- ACTION NEEDED: 47 old logs should be distilled into MEMORY.md and archived
- MEMORY.md: 65 lines, 9 KB

## 4. Script Inventory [!]

- Active scripts: 177 JS, 23 shell
...
2. [FIX] 3. Memory Hygiene: ACTION NEEDED: 47 old logs should be distilled into MEMORY.md and archived
...
*Generated by Oops weekly-review.js — 2026-03-20T17:00:09.632Z*
