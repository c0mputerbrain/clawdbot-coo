...
- Avg criticals: 2.4 | Avg warnings: 9.3
- Warnings every day — recurring issues not being resolved
- KB growth: 2300 -> 2300 files (+0)
- Memory growth: 1153 -> 1159 files (+6)
- Recurring warnings: [P1] Feedback Loop (7x), [P1] Frontmatter (7x), [P1] Push Health (7x), [P2] Scripts (7x)
...
- Sample frontmatter check: 5/5 complete
  amibroker/afl-functions/int.md: complete
  amibroker/kb/2015-01-26-choosing-compression-method-for-aux1-and-aux2-fields.md: complete
  trade-ideas/transcript-oddsmaker-calendar-tab.md: complete
  amibroker/afl-functions/setchartbkcolor.md: complete
  amibroker/kb/2014-03-07-amibroker-on-tablets-and-smartphones.md: complete
- Topic clusters: 23

## 3. Memory Hygiene [!]

- Memory directory: 1164 files, 4.1 MB
- Daily logs: 88 total, 75 older than 14 days
- ACTION NEEDED: 75 old logs should be distilled into MEMORY.md and archived
...
2. [FIX] 1. Audit Trends (Last 7 Days): Recurring warnings: [P1] Feedback Loop (7x), [P1] Frontmatter (7x), [P1] Push Health (7x), [P2] Scripts (7x)
3. [FIX] 3. Memory Hygiene: ACTION NEEDED: 75 old logs should be distilled into MEMORY.md and archived
...
*Generated by Oops weekly-review.js — 2026-04-17T17:00:11.637Z*
