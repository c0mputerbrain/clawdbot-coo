...
- Audits this week: 7
- Grades: B, A, B, B, B, B, B
- Avg criticals: 2.1 | Avg warnings: 9.6
- KB growth: 2299 -> 2300 files (+1)
- Memory growth: 1144 -> 1149 files (+5)
- Recurring warnings: [P1] Frontmatter (7x), [P1] Feedback Loop (7x), [P2] Scripts (7x), [P1] Push Health (4x)

## 2. KB Quality [OK]

- Files indexed: 2307
- Keywords: 9622
- TOPICS-INDEX.json: 524 KB
- KEYWORDS-INDEX.json: 4523 KB
- FILES-INDEX.json: 1349 KB
- Sample frontmatter check: 5/5 complete
  amibroker/afl-functions/status.md: complete
  trade-ideas/filters/PMVol.md: complete
  amibroker/kb/forum/2020-04-01-data-sources-make-backups-yes-you-need-a-backup.md: complete
  amibroker/afl-functions/nullcount.md: complete
  amibroker/afl-functions/error.md: complete
- Topic clusters: 23

## 3. Memory Hygiene [!]

- Memory directory: 1150 files, 4.0 MB
- Daily logs: 74 total, 61 older than 14 days
- ACTION NEEDED: 61 old logs should be distilled into MEMORY.md and archived
- MEMORY.md: 68 lines, 11 KB

## 4. Script Inventory [!]

- Active scripts: 216 JS, 24 shell
...
2. [FIX] 3. Memory Hygiene: ACTION NEEDED: 61 old logs should be distilled into MEMORY.md and archived
3. [FIX] 4. Script Inventory: Version sprawl: build-best-trades (2 versions), build-drc-032726 (2 versions), build-weekly-review-032326 (2 versions), notion-dave-mabe (2 versions), patch-charts-et-shading (2 versions), slt-enrich (2 versions)
4. [FIX] 5. Edge Intelligence Check:   FAIL: KB-SEARCH.md referenced

---

*Generated by Oops weekly-review.js — 2026-04-03T17:00:16.736Z*
